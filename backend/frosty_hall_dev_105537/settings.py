"""
Django settings for frosty_hall_dev_105537 project.
...
ROOT_URLCONF = 'frosty_hall_dev_105537.urls'
...
WSGI_APPLICATION = 'frosty_hall_dev_105537.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_hall_dev_105537 API",
    "DESCRIPTION": "API documentation for frosty_hall_dev_105537 App",
    "VERSION": "v1",
}
